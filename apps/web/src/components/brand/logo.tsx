...
export function LogoMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 64 64" aria-hidden className={cn("size-8", className)}>
      ...
      <path d="M22 46V19h22" stroke="#dff2e7" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      <path d="M22 32.5h15" stroke="#8fd9b3" strokeWidth="6" strokeLinecap="round" fill="none" />
    </svg>
  )
}
