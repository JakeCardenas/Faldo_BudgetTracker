...
export const TOOLS: { slug: string; title: string; description: string; icon: LucideIcon }[] = [
  ...
  { slug: "budget-planner", title: "50/30/20 planner", description: "Split your pay and compare with real spending.", icon: PieChart },
